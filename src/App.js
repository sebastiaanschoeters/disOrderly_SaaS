...
import ProtectedRoute from './Extra components/ProtectedRoute'; // ProtectedRoute component
    ...
    return (
        <Router>
            ...
            <Routes>
                ...
                <Route path="/clientOverview" element={
                    <ProtectedRoute allowedRoles={["caretaker, admin"]}>
                        <Search />
                    </ProtectedRoute>
                } />
                <Route path="/caretakerProfile" element={
                    <ProtectedRoute allowedRoles={["caretaker, admin"]}>
                        <Search />
                    </ProtectedRoute>
                } />
                <Route path="/caretakerProfileEdit" element={
                    <ProtectedRoute allowedRoles={["caretaker, admin"]}>
                        <Search />
                    </ProtectedRoute>
                } />
                ...
                <Route path="/profilePersonal" element={
                    <ProtectedRoute allowedRoles={["user"]}>
                        <PersonalProfilePage />
                    </ProtectedRoute>
                } />
                <Route path="/chatOverview" element={
                    <ProtectedRoute allowedRoles={["user"]}>
                        <ChatOverviewPage />
                    </ProtectedRoute>
                } />
                ...
                <Route path="/chatSuggestion" element={
                    <ProtectedRoute allowedRoles={["user"]}>
                        <ChatSuggestionPage />
                    </ProtectedRoute>
                } />
